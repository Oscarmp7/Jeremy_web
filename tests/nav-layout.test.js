...
test('theme transition uses an editorial horizontal grade while keeping the home reel stable', () => {
  ...
  assert.match(themeSource, /theme-grade/)
  assert.match(themeSource, /xPercent/)
  assert.doesNotMatch(themeSource, /yPercent/)
  assert.match(themeCss, /\.theme-grade/)
  assert.match(themeCss, /\.theme-grade__glow/)
  assert.match(themeCss, /linear-gradient\(90deg/)
