    ...
    <div className="project-modal" role="dialog" aria-modal="true" aria-label={project.title}>
      ...
      <div className="project-modal__content">
        ...
        <div className="project-modal__video">
          {project.vimeoId !== '0' ? (
            <iframe
              src={`https://player.vimeo.com/video/${project.vimeoId}?autoplay=1&color=46BBD9&title=0&byline=0&portrait=0`}
              width="100%"
              height="100%"
        ...
        <div className="project-modal__info" style={{ borderTop: '1px solid var(--line)', marginTop: '0' }}>
          <div>
            <p
              style={{
          ...
          <div>
            ...
            <p style={{ color: 'var(--text)', fontFamily: 'var(--font-body)', textTransform: 'capitalize' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text)', fontFamily: 'var(--font-hud)', fontSize: '12px' }}>
              {project.tags.join(' • ')}
            </p>
          </div>
        </div>
